...
# Use wasm-bindgen to generate the JS bindings with no-modules
echo "Generating JS bindings with wasm-bindgen..."
wasm-bindgen --target no-modules --no-typescript --out-dir target/site/pkg target/wasm32-unknown-unknown/release/web.wasm
