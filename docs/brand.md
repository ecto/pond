...
| `header-light.png` / `header-dark.png` | 1500×500 Twitter/X headers. Booster K1, Unitree H2, YAM arm, and Unitree Go2 at true scale on one floor that runs to the camera. No mark. |
